...
openai.api_key = "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"

# Set your PubMed API key
pubmed_api_key = "caa6d7a3cc5ab4ff6eaab31a61fb8610bb09"
...
def fetch_paper_abstract(query, limit=15):
    ...
    api_key = "CGcH1D5EkY1KvkzSny3jZ9sjUncb3bIk2zqGCzwl"
...
def main():
    query = "Acinetobacter lwoffii has been evolved in the lab to be resistant to which of these antibiotics?"
